...
const ExportModal = ({ isOpen, onClose, exportData, columns, jobType = 'report' }) => {
    ...
    const exportOptions = [
        { type: 'excel', icon: <ExcelIcon />, label: 'Excel (.xlsx)', color: 'green', description: 'Export as Microsoft Excel spreadsheet' },
        { type: 'csv', icon: <CsvIcon />, label: 'CSV (.csv)', color: 'blue', description: 'Export as Comma Separated Values' },
        { type: 'pdf', icon: <PdfIcon />, label: 'PDF (.pdf)', color: 'red', description: 'Export as Portable Document Format' }
    ];
