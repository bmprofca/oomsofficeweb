  ...
  return (
    <Routes>
      ...
      <Route path=":type?" element={<Broadcast />}>
        ...
        <Route
          path="text-message/static-templates"
          element={<TextMessageStaticTemplates />}
        />
        <Route
          path="text-message/dynamic-templates"
          element={<TextMessageDynamicTemplates />}
        />
        <Route
          path="text-message/configuration"
          element={<TextMessageConfiguration />}
        />

        {/* Nested routes for WhatsApp */}
        <Route path="whatsapp/send/:channel" element={<WhatsAppSend />} />
        <Route
          path="whatsapp/static-templates/:channel"
          element={<WhatsAppStaticTemplates />}
        />
        <Route
          path="whatsapp/dynamic-templates/:channel"
          element={<WhatsAppDynamicTemplates />}
        />
        <Route
          path="whatsapp/configuration/:channel"
        ...
        <Route
          path="push/dynamic-templates"
          element={<PushDynamicTemplates />}
        />
