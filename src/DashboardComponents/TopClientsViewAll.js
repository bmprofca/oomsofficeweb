...
const TopClientsViewAll = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            ...
            <div
                className={`pt-16 transition-all duration-300 ease-in-out w-full ${isMinimized ? "md:pl-20" : "md:pl-[260px]"
                    }`}
            >
                                                ...
                                                {currentItems.map((client, index) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <td className="px-3 py-2.5">
                                                                <div
                                                                    className={`inline-flex h-7 w-7 items-center justify-center rounded-full text-[11px] font-bold ${rank <= 3
