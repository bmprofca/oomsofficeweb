...
const EXACT_TITLES = {
  ...
  '/finance/voucher/staff-expenses': 'Staff Expenses',
  ...
  '/staff/office-assistance/follow-up': 'Debtor Follow-up',
  ...
  '/broadcast/sms/fast2sms/campaigns/create': 'Create SMS Campaign',
  '/broadcast/sms/ooms-system/campaigns': 'OOMS System SMS Campaigns',
  '/broadcast/sms/ooms-system/campaigns/create': 'Create OOMS System SMS Campaign',
  '/broadcast/sms/ooms-system/campaigns/schedules': 'OOMS System SMS Schedules',
...
const PATTERN_TITLES = [
  ...
  { path: '/broadcast/sms/fast2sms/campaigns/:campaignId', title: 'SMS Campaign Details' },
  { path: '/broadcast/sms/ooms-system/campaigns/:campaignId', title: 'OOMS System SMS Campaign Details' },
