...
export default function ClientsStep({
    ...
    const isFirmMode = selectionMode === 'firm';
    const firmTabDisabled = (firmsLocked || groupsLocked) && !isFirmMode;
    const groupTabDisabled = (firmsLocked || groupsLocked) && isFirmMode;
    ...
    useEffect(() => {
        ...
        if (!root || !sentinel || firmsLocked || !firmSearchHasMore || !isFirmMode) return;
    ...
    }, [firmsLocked, firmSearchHasMore, availableFirms.length, firmSearchQuery, isFirmMode]);
        ...
        <div className="space-y-6">
            <div className="flex items-center">
                <div
                    ...
                    role="tablist"
                    aria-label="Select firms or groups"
                >
                    <button
                        type="button"
                        role="tab"
                        aria-selected={isFirmMode}
                        disabled={firmTabDisabled}
                        onClick={() => onSelectionModeChange?.('firm')}
                    ...
                    <div className="flex items-start gap-2.5">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-indigo-600 mt-0.5">
                                {isFirmMode
                                    ? 'Based on selected firms'
                                    : 'Based on firms in selected groups'}
                            </p>
                        </div>
                    </div>
