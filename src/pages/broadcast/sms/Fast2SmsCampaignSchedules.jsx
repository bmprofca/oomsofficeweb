                      ...
                      {rows.map((row, index) => {
                        ...
                        return (
                          <tr key={row.schedule_id} className={TABLE_ROW}>
                            ...
                            <td className={TABLE_TD}>
                              <p className="text-xs font-medium capitalize text-blue-700 m-0">
                                {row.schedule_type}
                              </p>
                                ...
                                {canSend ? (
                                  <>
                                    ...
                                    <button
                                      ...
                                      className="p-2 rounded-lg border border-gray-200 text-blue-600 hover:bg-blue-50 disabled:opacity-50"
                                    >
                                      {active ? (
...
export default Fast2SmsCampaignSchedules;
