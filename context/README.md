...
This folder contains modular context notes extracted from `context.md`.
...
- `auth-and-api.md` - Header auth contract and API base usage
- `tables.md` - Table layout and pagination conventions
- `finance-registers.md` - Received, discount, bank, capital register pages (layout, APIs, helpers)
- `colors.md` - UI color and tone conventions used in app
