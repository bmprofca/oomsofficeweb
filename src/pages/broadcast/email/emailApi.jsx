...
export const emailApi = {
  ...
  deleteConfig: (payload) => emailAxios.put('/broadcast/email/config/delete', payload).then(unwrap),
  ...
  listStaticTemplates: (params) => emailAxios.get('/broadcast/email/static-template/catalog', { params }).then(unwrap),
  ...
  getTemplateVariables: (templateType) => emailAxios.get(`/broadcast/email/static-template/suggested-variables/${encodeURIComponent(templateType)}`).then(unwrap),
  changeStaticTemplateStatus: (payload) => emailAxios.put('/broadcast/email/static-template/change-status', payload).then(unwrap),
  setDefaultStaticTemplate: (payload) => emailAxios.put('/broadcast/email/static-template/change-status', { ...payload, status: 'active' }).then(unwrap),
