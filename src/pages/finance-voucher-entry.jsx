...
} from "../components/Modals/CreateTransactions";
...
const FinanceEntry = () => {
  ...
  const [paymentReceivedFormModal, setPaymentReceivedFormModal] =
    useState(false);
  ...
  return (
    <div className="min-h-screen bg-slate-50 overflow-hidden">
      ...
      <div
        className={`pt-16 transition-all duration-300 ease-in-out h-screen overflow-hidden ${isMinimized ? "md:pl-20" : "md:pl-[260px]"}`}
      >
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                  {[
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-8 h-8 ${isLocked ? "bg-slate-100 text-slate-400" : btn.iconBg} rounded-lg flex items-center justify-center mr-3 flex-shrink-0`}
                        >
                          {isLocked ? (
                            <FiLock className="w-4 h-4 text-slate-400" />
                          ) : (
                            <svg
                              className={`w-4 h-4 ${btn.iconColor}`}
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
              ...
              <div className="bg-white rounded-lg border border-slate-200 p-4">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                  {[
                    ...
                    {
                      name: "Loan & Advances",
                      hoverBg: "hover:bg-yellow-50 hover:border-yellow-200",
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    },
                    {
                      ...
                      iconColor: "text-red-600",
                      iconBg: "bg-red-100",
                      setOpen: () => setPurchaseFormModal(true),
                    },
                    {
                      name: "Received",
                      icon: FiCreditCard,
                      iconColor: "text-blue-600",
                      iconBg: "bg-blue-100",
                      setOpen: () => setPaymentReceivedFormModal(true),
                    },
                    {
                      name: "Payment",
                      ...
                      iconColor: "text-indigo-600",
                      iconBg: "bg-indigo-100",
                      setOpen: () => setPaymentSendFormModal(true),
                    },
                    {
                      name: "Contra",
                      icon: FiRepeat,
                      ...
                      iconBg: "bg-teal-100",
                      setOpen: () => setContraFormModal(true),
                    },
                    {
                      name: "Journal",
                      icon: FiFileText,
                      iconColor: "text-red-600",
                      iconBg: "bg-red-100",
                      setOpen: () => setJournalFormModal(true),
                    },
                    {
                      name: "Expenses",
                      icon: FiPieChart,
                      iconColor: "text-orange-600",
                      iconBg: "bg-orange-100",
                      setOpen: () => setExpenseFormModal(true),
                    },
                    {
                      name: "Discount",
                      icon: FiPieChart,
                      iconColor: "text-orange-600",
                      iconBg: "bg-orange-100",
                      setOpen: () => setDiscountFormModal(true),
                    },
                  ].map((entry, idx) => {
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3 min-w-0">
                            <div
                              className={`${isLocked ? "bg-slate-100 text-slate-400" : entry.iconBg} rounded-lg p-2 flex-shrink-0`}
                            >
                              {isLocked ? (
                                <FiLock className="w-5 h-5 text-slate-400" />
                              ) : (
                                <Icon
                                  className={`w-5 h-5 ${entry.iconColor}`}
                                />
                              )}
                            </div>
                          ...
                          {isLocked && (
                            <FiLock className="w-3.5 h-3.5 text-slate-400 flex-shrink-0" />
                          )}
                        </div>
                      </motion.div>
                    );
              ...
              <div className="bg-white rounded-lg border border-slate-200 p-4 h-fit">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    {
                      name: "Create Ledger",
                      action: () => setCreateLedgerModal(true),
                      hoverBg: "hover:bg-green-50 hover:border-green-200",
                      iconBg: "bg-green-100",
                      iconColor: "text-green-600",
                      svgPaths: ["M12 6v6m0 0v6m0-6h6m-6 0H6"],
